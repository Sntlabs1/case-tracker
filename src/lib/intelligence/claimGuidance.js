...
const STATUTORY_BASELINE = {
  ...
  FL_FTSA: {
    ...
    perViolation: "$500 per violation (up to $1,500 for willful violations)",
    elementsToPlead: [
      "Defendant made or caused to be made a telephonic sales call to plaintiff's number",
      "Call was made using an automated system or prerecorded message",
      "Plaintiff did not consent to receive such calls, or consent was not obtained through a signed written agreement",
      "The FL FTSA applies to intrastate AND interstate calls to FL numbers (post-2021 amendment)",
      "No prior express written consent from the plaintiff to the specific calling party",
    ],
    documentsToCollect: [
      ...
      "FL carrier records confirming the number is a FL-registered number",
      "Any written complaints, cease-and-desist letters, or opt-out requests sent to defendant",
    ],
    factualQuestionsForIntake: [
      "Are you a Florida resident or was your phone number registered in Florida at the time of the calls?",
      "What phone number were the calls made to? (Confirm FL area code or FL carrier registration)",
      "How many calls or texts did you receive from the defendant?",
      "Did you ever give written consent to receive such calls? If so, do you have a copy?",
      "Did you ask the defendant to stop? What happened after you asked?",
    ],
    redFlags: [
      "FL FTSA requires calls to a 'Florida telephone number' — confirm carrier registration",
      "Post-2021 amendment expanded scope but is still contested in some federal circuits",
      "Consent must be in writing for FL FTSA — verbal consent or checking a website box may not qualify",
      "Statute of limitations: 4 years (same as TCPA)",
    ],
  },
  FCRA_FURNISHER: {
