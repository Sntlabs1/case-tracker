...
export const STATUS_COLORS = { "New Lead":"#2D7D95","Investigating":"#8b5cf6","Case Filed":"#f59e0b","MDL Pending":"#ec4899","MDL Active":"#ef4444","Settled":"#22c55e","Closed":"#6b7280" };
export const OUTCOME_COLORS = { certified: "#22c55e", denied: "#ef4444", settled: "#2D7D95", pending: "#f59e0b", mixed: "#8b5cf6" };
export const INDUSTRY_COLORS = { Pharmaceutical: "#8b5cf6", "Medical Device": "#ef4444", Auto: "#2D7D95", "Consumer Products": "#f59e0b", "Tech/Privacy": "#06b6d4", Financial: "#22c55e", Environmental: "#84cc16", "Food & Beverage": "#f97316", Securities: "#ec4899" };
